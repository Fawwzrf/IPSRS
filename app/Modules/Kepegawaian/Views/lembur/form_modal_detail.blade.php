      ...
      <div class="col-lg-6 col-md-12">
        ...
        <div class="mb-1 row">
          ...
          <div class="col-lg-9 col-md-6">
            ...
            <input type="hidden" name="pegawai_id" value="<?= (@$main) ? @$pegawai['pegawai_id'] : _ses_get('pegawai_id') ?>" readonly>
          </div>
        </div>
        ...
        <div class="mb-1 row">
          ...
          <div class="col-lg-4">
            <input type="text" name="mulai_tgl" id="mulai_tgl" class="form-control waktu" value="<?= @to_date($main['mulai_tgl'], '-', 'full_date') ?>" readonly>
          </div>
        </div>
        <div class="mb-1 row">
          <label class="col-lg-3 col-md-6 col-form-label required">Selesai</label>
          <div class="col-lg-4">
            <input type="text" name="selesai_tgl" id="selesai_tgl" class="form-control waktu" value="<?= @to_date($main['selesai_tgl'], '-', 'full_date') ?>" readonly>
          </div>
        </div>
        <div class="mb-1 row">
        ...
        <div class="mb-1 row">
          ...
          <div class="col-lg-9 col-md-6">
            <textarea class="form-control" name="uraian" id="uraian" rows="5" required readonly><?= @$main['uraian'] ?></textarea>
          </div>
        </div>
      </div>
      <div class="col-lg-6 col-md-12">
        <div class="mb-1 row">
          ...
          <div class="col-lg-9 col-md-6">
            <textarea class="form-control" name="link" id="link" rows="5" required readonly><?= @$main['link'] ?></textarea>
          </div>
        </div>
        ...
        <?php if (@$main['gambar_2'] != "") : ?>
          <div class="mb-1 row">
            ...
            <div class="col-lg-6 col-md-6">
              <a href="<?= site_url('app/get_file/lembur/' . @$main['gambar_2']) ?>" target="_blank">
        ...
        <?php if (@$main['gambar_3'] != "") : ?>
          <div class="mb-1 row">
            ...
            <div class="col-lg-6 col-md-6">
              <a href="<?= site_url('app/get_file/lembur/' . @$main['gambar_3']) ?>" target="_blank">
