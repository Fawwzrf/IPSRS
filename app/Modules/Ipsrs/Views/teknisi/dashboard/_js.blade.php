<script>
    document.addEventListener("DOMContentLoaded", function() {
        try {
            ...
            try {
                ...
                // Fallback jika Chart.js tidak berfungsi
                document.getElementById('chart-kinerja').innerHTML = '<p class="text-center text-muted pt-4">Tidak dapat menampilkan grafik. Silakan refresh halaman.</p>';
            }
        } catch (error) {
    ...
    // Fungsi untuk refresh dashboard dengan AJAX
    function refreshDashboard() {
        ...
        // Gunakan setTimeout untuk memberikan waktu untuk loading overlay muncul
        setTimeout(function() {
            // Gunakan vanilla reload untuk kesederhanaan
