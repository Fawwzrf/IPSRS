<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        // Datepicker tidak ada di sini karena tidak ada filter tanggal di index kategori
        ...
        tabel = $('#datatable-main').DataTable({
            ...
            "bFilter": false,
            "columns": [{
                    "data": "kategori_asset_id", // Untuk nomor urut
                    "sortable": false,
                ...
                {
                    "data": "kategori_asset_id", // Untuk Aksi
                    "className": "text-left",
                    "render": function(data, type, row, meta) {
    ...
    $(document).on('shown.bs.modal', '#my-modal-1', function (e) { 
        ...
        // Datepicker tidak ada di sini karena tidak ada input tanggal di form kategori

        modalContent.find("#form").validate({
            rules: {
                kategori_asset_id: { required: true },
                kategori_asset_nm: { required: true },
                active_st: { required: true },
            },
            messages: {
                kategori_asset_id: { required: "ID Kategori wajib diisi." },
                kategori_asset_nm: { required: "Nama Kategori wajib diisi." },
        ...
        // Tidak ada logika generate ID di sini
        // Tidak ada logika filter dinamis di sini
    });
</script>