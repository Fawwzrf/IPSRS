                    ...
                    <table class="table table-vcenter card-table mb-0" id="table-komplain">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">{{ \Illuminate\Support\Str::limit($item['deskripsi'], 150) }}</td>
                            ...
                            @empty
                            <tr>
                                <td colspan="5" class="text-center text-muted py-4">Anda belum pernah membuat laporan.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
