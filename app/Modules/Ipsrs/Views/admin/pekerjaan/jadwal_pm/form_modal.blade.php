            ...
            <div class="mb-3 row">
                ...
                <div class="col-lg-9">
                    <select class="form-select chosen-select" name="frekuensi" required>
                        ...
                        <option value="Kuartalan" @if (@$main['frekuensi'] == 'Kuartalan') selected @endif>Kuartalan (3 Bulan)
                        </option>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-lg-9">
                    <select class="form-select chosen-select" name="jenis" required>
                        ...
                        <option value="Pembersihan" @if (@$main['jenis'] == 'Pembersihan') selected @endif>Pembersihan
                        </option>
                        ...
                        <option value="PenggantianPart" @if (@$main['jenis'] == 'PenggantianPart') selected @endif>Penggantian
                            Part</option>
                        <option value="Penyesuaian" @if (@$main['jenis'] == 'Penyesuaian') selected @endif>Penyesuaian
                        </option>
                    </select>
                </div>
            </div>
                ...
                <div class="col-lg-9 pt-2">
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="status" value="aktif"
                            @if (@$main == '' || @$main['status'] == 'aktif') checked @endif>
                        <span class="form-check-label">Aktif</span>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="status" value="dibatalkan"
                            @if (@$main['status'] == 'dibatalkan') checked @endif>
