    ...
    <div class="card-body">
        <fieldset class="border p-2 rounded mb-3">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-lg-9">
                    <select class="form-select chosen-select" name="sparepart_id" required>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-lg-4">
                    <input type="number" name="jumlah" class="form-control" min="1" value="{{ @$main['jumlah'] ?? 1 }}" required>
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-lg-5">
                    <input type="text" name="harga_satuan" class="form-control" value="{{ @$main['harga_satuan'] ?? 0 }}">
                </div>
            </div>
        </fieldset>
        ...
        <fieldset class="border p-2 rounded mb-3">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-lg-9">
                    <input type="text" name="vendor" class="form-control" value="{{ @$main['vendor'] }}">
                </div>
            </div>
            <div class="mb-3 row">
                <label class="col-lg-3 col-form-label">No. Faktur/PO</label>
                <div class="col-lg-9">
                    <input type="text" name="no_faktur" class="form-control" value="{{ @$main['no_faktur'] }}">
                </div>
            </div>
            <div class="mb-1 row">
        ...
        <div class="row mt-3">
            <div class="col-lg-9 offset-lg-3">
                <button type="submit" class="btn btn-primary" onclick="_save(event)"><i class="fas fa-save me-2"></i> Simpan Transaksi</button>
