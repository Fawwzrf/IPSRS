    ...
    <div class="card-body">
        <fieldset class="border p-2 rounded mb-3">
                ...
                <div class="col-lg-9">
                    <select class="form-select chosen-select" name="sparepart_id" id="sparepart_id" required>
                        ...
                        <?php foreach ($all_sparepart as $sp): ?>
                            <option value="<?= $sp['sparepart_id'] ?>" <?php if (@$main['sparepart_id'] == $sp['sparepart_id']) echo 'selected'; ?>>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-lg-5">
                    <input type="text" name="tgl" id="tgl" class="form-control datepicker-notauto"
                        value="<?= @$main ? to_date(@$main['tgl'], '-', 'date') : date('d-m-Y') ?>" required>
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-lg-5">
                    <input type="text" name="harga_satuan" id="harga_satuan" class="form-control"
                        value="<?= @$main['harga_satuan'] !== null ? numId(@$main['harga_satuan']) : 0 ?>">
                </div>
            </div>
        </fieldset>
